...
namespace drawNS {
  ...
  public:
     ...
     */
    virtual unsigned int draw_line(const Point3D & point1, const Point3D & point2, const std::string & color = "black") = 0;
    /*!
     ...
     * \return id of shape (see erase_shape, change_shape_color)
     */
    virtual unsigned int draw_polygonal_chain(const std::vector<Point3D> & points, const std::string & color = "black") = 0;
    /*!
     ...
     * \return id of shape (see erase_shape, change_shape_color)
     */
    virtual unsigned int draw_polyhedron(const std::vector<std::vector<Point3D> > & points_map, const std::string & color = "black") = 0;
    /*!
     ...
     * \return id of shape (see erase_shape, change_shape_color)
     */
    virtual unsigned int draw_surface(const std::vector<std::vector<Point3D> > & points_map, const std::string & color = "black") = 0;
    /*!
     * \brief erase shape by id
     * \param id - id of shape
     */
    virtual void erase_shape(unsigned int id) = 0;
    /*!
     * \brief change color of shape
     * \param id - id of shape
     * \param color - color of line (see class description)
     */
    virtual void change_shape_color(unsigned int id, const std::string & color) = 0;
    /*!
